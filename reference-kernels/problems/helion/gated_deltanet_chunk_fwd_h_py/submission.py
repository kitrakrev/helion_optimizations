...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    (2, 512, 3, 64, 64): helion.Config(advanced_controls_file=_ACF, block_sizes=[8], indexing=['pointer', 'pointer', 'pointer', 'pointer', 'pointer', 'tensor_descriptor', 'pointer'], l2_groupings=[1], load_eviction_policies=['', 'last', '', '', ''], loop_orders=[[0, 1]], num_sm_multiplier=4, num_stages=1, num_warps=4, pid_type='persistent_blocked', range_flattens=[None, False], range_multi_buffers=[None, None], range_num_stages=[0, 4], range_unroll_factors=[0, 0], range_warp_specializes=[None, None]),
