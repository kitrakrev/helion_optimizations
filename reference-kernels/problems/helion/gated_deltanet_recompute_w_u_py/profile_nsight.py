#!/usr/bin/env python3
"""
Local Nsight Compute profiling for gated_deltanet recompute_w_u.

Run with: python eval.py profile-nsight gated_deltanet_recompute_w_u_py/

Or directly: ncu -o w_u_profile --set basic python profile_nsight.py [benchmark_idx]
"""
